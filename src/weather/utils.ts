...
export const cityNameJp: { [key: string]: string } = {
  ...
  // --- 東京 ---
  "東京": "Tokyo", "とうきょう": "Tokyo", "八王子": "Hachioji", "立川": "Tachikawa", 
  "武蔵野": "Musashino", "三鷹": "Mitaka", "青梅": "Ome", "府中": "Fuchu", "昭島": "Akishima", 
  "調布": "Chofu", "町田": "Machida", "小金井": "Koganei", "小平": "Kodaira", "日野": "Hino", 
  "東村山": "Higashimurayama", "国分寺": "Kokubunji", "国立": "Kunitachi", "福生": "Fussa", 
  "狛江": "Komae", "東大和": "Higashiyamato", "清瀬": "Kiyose", "東久留米": "Higashikurume", 
  "武蔵村山": "Musashimurayama", "多摩": "Tama", "稲城": "Inagi", "羽村": "Hamura", 
  "あきる野": "Akiruno", "西東京": "Nishitokyo",
